...
@IonicPage()
@Component({
  selector: 'page-pilihkemaskinimakpro',
  templateUrl: 'Pilihkemaskinimakpro.html',
})

export class PilihkemaskinimakproPage {

  senaraiMakPro$: Observable<Kproduk[]>;

  constructor(public navCtrl: NavController, private product: SenaraiMakProService,
  ){
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad PilihkemaskinimakproPage');
  }
